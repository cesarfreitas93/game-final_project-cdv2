...
var Juego2 = {
    preload: function() {
        juego.load.image('bg','img/bg_3.png');
    ...
    create: function() {
        ...
        //fondo = juego.stage.backgroundColor = "6dc36d";
      ...
      var animacion = juego.add.tween(enemigos).to(
		...
		juego.add.text(140,20, "Score: ",{font: "bold 24px Arial",fill: "greenyellow"});
		txtScore = juego.add.text(230,20, score+"",{font: "bold 24px Arial",fill: "greenyellow"});
